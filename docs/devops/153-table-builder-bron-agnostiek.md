...
**Work items:** Feature #AB:130 → #AB:152 (Fase A), #AB:139 (Fase B), #AB:141 (Fase C), #AB:140 (Fase D), **#AB:153 (Fase E, nieuw)**.
...
| F | #AB:135/#AB:136 | Per-gebruiker zichtbaarheid + tests + OTAP-runbook + versie-bump |

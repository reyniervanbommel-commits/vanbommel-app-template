...
|---------|-------|------------:|----:|-------:|----------|------------|
| J1 | Board-load / | 178 | 853 | 941 | server | 0 |
| J2 | /rccp | — | 0 | 0 | sql | 0 |
| J3 | Terugkeer / | — | 2448 | 2800 | sql | **0** |
...
|----|---------|-------|------------:|-----------:|----------|--------------:|
| BL-001 | J1 | PO board-load / (hard reload) | 178 | 125 | server | 159 |
| BL-002 | J2 | Route /rccp dashboard load | — | — | sql | 0 |
| BL-003 | J3 | Return / after /rccp (duplicate PO-fetch) | — | — | sql | 0 |

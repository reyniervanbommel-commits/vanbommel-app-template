-- Migratie 030: datatype 'date_period' toestaan in po_columns en tb_columns (Date W/M kolommen).
-- Idempotent: drop + recreate van de CHECK-constraints met date_period toegevoegd.

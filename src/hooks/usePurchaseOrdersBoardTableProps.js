...
export function usePurchaseOrdersBoardTableProps({
  ...
  return useMemo(() => ({
    ...
    columnConfig: {
      headerColumnWidths: mergeProductImageColumnWidths(pageState.headerColumnWidths),
      lineColumnWidths: mergeProductImageColumnWidths(pageState.lineColumnWidths),

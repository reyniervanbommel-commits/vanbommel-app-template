...
export const DATA_MODEL_INFO = {
  ...
  discoverFields: 'Reads all fields from the D365 entity and adds any missing columns, hidden by default. Turn on “Visible in table” to show a column on the board.',

...
export const DATA_MODEL_INFO = {
  ...
  rccp: 'Allowlist only: makes this numeric column available on the RCCP Quantities tab. It does not add the column to the chart by itself — pick it on a quantity card there, then optionally set Open or Received.',

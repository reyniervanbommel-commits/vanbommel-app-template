...
/**
 * Page-variant van de chart builder (los paneel op de BI-pagina, niet de flyout).
 * Bevat alleen JSX/rendering; alle state komt uit de meegegeven `builder`.
 */
export default function ChartBuilderPageForm({
  builder, columns, config, measureColumns, isDateDimension,
  multiMeasureMode, selectedMeasures, chart, onSave, onCancel, busy, isValid,
}) {
  ...
  const handleNameChange = useCallback((_, data) => builder.setName(data.value), [builder]);
        ...
        <div className={styles.section}>
          ...
          <div className={styles.fieldGrid}>
            <Field label="Name" required className={styles.fieldNarrow}>
              <Input size={CONTROL_SIZE} value={builder.name} onChange={handleNameChange} placeholder="Chart name" />
            </Field>

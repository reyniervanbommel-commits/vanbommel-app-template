...
const PurchaseOrderLineCellContent = memo(function PurchaseOrderLineCellContent({
  ...
  const showProductImage = isFirstColumn && !line?.isRemoved;
  ...
  return showProductImage ? (
    <span className={styles.statusWrap}>
      <PurchaseOrderProductImageCell dataAreaId={order.dataAreaId} itemNumber={itemNumber} />
      {content}
    </span>
  ) : content;
});
            ...
            return (
              ...
              >
                <PurchaseOrderLineCellContent
                  line={line}
                  column={column}
                  isFirstColumn={column === lineColumns[0]}
                  order={order}
